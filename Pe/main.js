...
const initiallyDisplayedCurrencies = ["USD", "EUR", "GBP", "JPY", "RUB","LBP","SEK"];
let baseCurrency;
...
fetch(dataURL)
  ...
  function calculate(){
    var x = parseInt( document.getElementById("heightt").value);
    var y =  parseInt (document.getElementById("weightt").value);
    var t = parseInt(x)/100;
    var z = y/(Math.pow(t,2));
    document.getElementById("body").value=z;
  }
...
const cmInput=document.getElementById("centi");
const mInput=document.getElementById("meters");
const kmInput=document.getElementById("kilo");
